param([int]$X, [int]$Y, [string]$OutFile)
...
"@
    ...
    # Re-get rect in case window moved
    [WinClick]::GetWindowRect($h, [ref]$r) | Out-Null
    $w = $r.Right - $r.Left
    $ht = $r.Bottom - $r.Top
