...
"@
    ...
    [WinType]::ShowWindow($h, 9) | Out-Null
    Start-Sleep -Milliseconds 300
    [WinType]::SetForegroundWindow($h) | Out-Null
    Start-Sleep -Milliseconds 500

    $r = New-Object WinType+tagRECT
    [WinType]::GetWindowRect($h, [ref]$r) | Out-Null
